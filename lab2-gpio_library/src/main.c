...
int main(void)
{
    ...
    // 0100 1101 ... the current reg value
    ...
    while (1)
    {
        ...
        //GPIO_write high(&PORTB, LED_GREEN);
        }
        else {
            led_value = 0;
            //PORTB = PORTB & ~ (1<<LED_GREEN);
          //mask after shift 0010 0000
          //inverted mask 1101 1111
          //current reg value 0111 1101
          //reg value after 0101 1101
            //PORTB = PORTB & ~ (1<<LED_RED);
